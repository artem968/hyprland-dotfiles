...
APPS="fuzzel neovim ranger kitty hyprland waybar cava nwg-look nwg-displays fish unzip firefox grim hyprpaper hyprpicker hyprlock hyprpolkitagent nautilus"
MISSING_APPS=""
